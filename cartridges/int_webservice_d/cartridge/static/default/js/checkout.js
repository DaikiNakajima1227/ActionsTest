...
if (AmazonSitePreferences.AMAZON_SFRA_6_1_0_ENABLED) {
    var customerHelpers = __webpack_require__(8);
}
var billingHelpers = __webpack_require__(19);
var shippingHelpers = __webpack_require__(13);
var formHelpers = __webpack_require__(9);
var scrollAnimate = __webpack_require__(10);
    ...
    $.fn.checkout = function () { // eslint-disable-line
        ...
        var members = {
            ...
            updateStage: function () {
                ...
                if (AmazonSitePreferences.AMAZON_SFRA_6_1_0_ENABLED) {
                    if (stage === 'customer') {
                        ...
                        if ($('.payment-details .amazon_pay-option').length) {
            ...
            initialize: function () {
                ...
                // Replace the Place Order button with Amazon Additional Pay button
                members.amazonAdditionalButton();
            ...
            amazonAdditionalButton: function() {
                // Replace the Place Order button with Amazon Additional Pay button
                if (checkoutStages[members.currentStage] === 'placeOrder') {
                    if (sessionStorage.getItem('paymentMethodId') === 'AMAZON_PAY' && $('.amazon_pay-option-apb').length) {
                        sessionStorage.setItem('placeOrderUrl', $('.place-order').data('action'));
                        $('.place-order').data('action', '#');
                        $('.place-order').addClass('d-none');

                        $.ajax({
                            url: $('#amazon-apb').data('url'),
                            method: 'POST',
                            success: function (data) {
                                $('#amazon-apb').html(data);
                            }
                        });
                    } else if (sessionStorage && sessionStorage.getItem('paymentMethodId') === 'CREDIT_CARD') {
                        $('#amazon-apb').html('');
                        $('.place-order').removeClass('d-none');

                        if (sessionStorage.getItem('placeOrderUrl')) {
                            $('.place-order').data('action', sessionStorage.getItem('placeOrderUrl'));
                        }
                    } else if (sessionStorage) { // Amazon Pay express checkout
                        $('#amazon-apb').html('');
                        $('.place-order').removeClass('d-none');

                        var amazonPlaceOrderUrl = $('.amazon_pay-tab').data('amazonpay-placeorderurl');

                        if (sessionStorage.getItem('placeOrderUrl')) {
                            $('.place-order').data('action', amazonPlaceOrderUrl);
                        }
...
var customerHelpers = __webpack_require__(8);
var addressHelpers = __webpack_require__(12);
var shippingHelpers = __webpack_require__(13);
var billingHelpers = __webpack_require__(14);
var summaryHelpers = __webpack_require__(18);
var formHelpers = __webpack_require__(9);
var scrollAnimate = __webpack_require__(10);
...
var formHelpers = __webpack_require__(9);
var scrollAnimate = __webpack_require__(10);
var createErrorNotification = __webpack_require__(11);
...
var addressHelpers = __webpack_require__(12);
var cleave = __webpack_require__(15);
...
var Cleave = __webpack_require__(16).default;
...
var baseBilling = __webpack_require__(14);
